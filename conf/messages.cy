...
directDebitConfirmation.details.amount.budgetPaymentPlan = Regular payment amount
...
suspensionPeriodRangeDate.title.change = Changing this suspension period
suspensionPeriodRangeDate.heading.change = Changing this suspension period
suspensionPeriodRangeDate.change.inset = This payment plan is suspended from {0} to {1}.
suspensionPeriodRangeDate.change.paragraph = To change this suspension period, edit the start date, end date, or both.
...
removeSuspensionConfirmation.title = Payment plan suspension removed
removeSuspensionConfirmation.heading = Payment plan suspension removed
removeSuspensionConfirmation.panel.title = Payment plan suspension removed
removeSuspensionConfirmation.h1 = What happens next
removeSuspensionConfirmation.p1 = This suspension for this payment plan has now been removed. The next payment of {0} for this plan will be collected on {1}. You may still see this suspension in your account for up to 36 hours.
removeSuspensionConfirmation.h2 = Payment plan details
removeSuspensionConfirmation.print = You can print this page for your records using the print function on your browser.
removeSuspensionConfirmation.link = Return to payment plan

paymentPlanSuspended.title = Payment plan suspended
paymentPlanSuspended.panel.title = Payment plan suspended
paymentPlanSuspended.panel.p = From <strong>{0}</strong> to <strong>{1}</strong>
...
paymentPlanSuspended.p1.normal = This payment plan has now been suspended. No payments will be taken from {0} to {1}.
paymentPlanSuspended.p1.change = This payment plan suspension period has now been changed. No payments will be taken from {0} to {1}.
paymentPlanSuspended.p2.normal = When the suspension period ends, your payment plan will resume on the next working day. It may take up to 36 hours for this suspension to appear in your account.
paymentPlanSuspended.p2.change = When the suspension ends, your payment plan will resume on the next working day. It may take up to 36 hours for this suspension change to appear in your account.
...
removingThisSuspension.title = Removing this suspension
removingThisSuspension.heading = Removing this suspension
removingThisSuspension.paymentDetails = Payment reference: <strong>{0}</strong>
removingThisSuspension.suspensionInfo = This suspension period is from <strong>{0}</strong> to <strong>{1}</strong>
removingThisSuspension.question = Are you sure you want to remove this suspension?
removingThisSuspension.checkYourAnswersLabel = removingThisSuspension
removingThisSuspension.error.required = Select one option.
removingThisSuspension.change.hidden =  Removing this suspension
...
advanceNotice.returnLink = Return to payment plan
...
paymentPlanLockedWarning.returnLink = Return to payment plans
...
amendPlanStartDate.startDate = Plan start date
...
amendPlanEndDate.endDate = Plan end date
...
amendPaymentPlanUpdate.returnLink = Return to payment plan
