...
paymentAmount.error.required = Dim ond punnoedd a cheiniogau all fod yn y swm
...
paymentDate.change.hidden =  dyddiad y taliad
...
planStartDate.fixedHint = Y dyddiad cynharaf y gallwch ddechrau yw {0}. Nodwch y dyddiad fel rhifau, er enghraifft 16 6 2025.
...
tellAboutThisPayment.p1.link.1 = this payment is early, late (yn agor tab newydd)
tellAboutThisPayment.p1.2 = , or
tellAboutThisPayment.p1.link.2 = neu’n daliad P11D (yn agor tab newydd)
...
regularPaymentAmount.error.required = Dim ond punnoedd a cheiniogau all fod yn y swm
...
totalAmountDue.error.required = Dim ond punnoedd a cheiniogau all fod yn y swm
...
systemError.link        = Desg Gymorth Gwasanaethau Ar-lein CThEF (yn agor tab newydd)
...
amendPlanStartDate.startDate.hidden = dyddiad y taliad
