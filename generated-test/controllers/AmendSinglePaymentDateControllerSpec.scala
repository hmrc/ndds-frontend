...
class AmendSinglePaymentDateControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val formProvider = new AmendSinglePaymentDateFormProvider()
  ...
  lazy val amendSinglePaymentDateRoute = routes.AmendSinglePaymentDateController.onPageLoad(NormalMode).url

  override val emptyUserAnswers = UserAnswers(userAnswersId)

  def getRequest(): FakeRequest[AnyContentAsEmpty.type] =
    FakeRequest(GET, amendSinglePaymentDateRoute)

  def postRequest(): FakeRequest[AnyContentAsFormUrlEncoded] =
    FakeRequest(POST, amendSinglePaymentDateRoute)
  ...
  "AmendSinglePaymentDate Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AmendSinglePaymentDatePage, validAnswer).success.value
