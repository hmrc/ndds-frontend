...
//    answers.get(SuspensionPeriodRangeDatePage).map { range: SuspensionPeriodRange =>
//
//      implicit val lang: Lang = messages.lang
//
//      val formattedValue =
//        s"${range.startDate.format(dateFormatter)} to ${range.endDate.format(dateFormatter)}"
//
...
//          ActionItemViewModel(
//            "site.change",
//            routes.SuspensionPeriodRangeDateController.onPageLoad(CheckMode).url
