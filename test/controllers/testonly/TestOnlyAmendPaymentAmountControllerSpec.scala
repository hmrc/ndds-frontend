...
class TestOnlyAmendPaymentAmountControllerSpec extends SpecBase with MockitoSugar {
  ...
  private val testOnlyRoute = controllers.testonly.routes.TestOnlyAmendPaymentAmountController.onPageLoad().url
  ...
  "TestOnlyAmendPaymentAmountController" - {
    ...
    "must return OK and the correct view for a GET with SinglePaymentPlan" in {
      ...
      running(application) {
        ...
        val request = FakeRequest(GET, testOnlyRoute)
        ...
        contentAsString(result) mustEqual view(
          form,
          NormalMode,
          controllers.routes.AmendingPaymentPlanController.onPageLoad()
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        val controller = application.injector.instanceOf[TestOnlyAmendPaymentAmountController]
        val request = FakeRequest(POST, testOnlyRoute).withFormUrlEncodedBody(("value", validAnswer.toString))
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        val controller = application.injector.instanceOf[TestOnlyAmendPaymentAmountController]
        val request = FakeRequest(POST, testOnlyRoute).withFormUrlEncodedBody(("value", "invalid value"))
