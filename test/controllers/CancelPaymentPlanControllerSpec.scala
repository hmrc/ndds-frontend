...
class CancelPaymentPlanControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val cancelPaymentPlanRoute = routes.CancelPaymentPlanController.onPageLoad(NormalMode).url
  ...
  "CancelPaymentPlan Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(CancelPaymentPlanPage, true).success.value
