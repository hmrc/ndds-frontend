...
class SuspensionPeriodRangeDateControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val suspensionPeriodRangeDateRoute = routes.SuspensionPeriodRangeDateController.onPageLoad(NormalMode).url
  ...
  "SuspensionPeriodRangeDate Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(SuspensionPeriodRangeDatePage, validAnswer).success.value
