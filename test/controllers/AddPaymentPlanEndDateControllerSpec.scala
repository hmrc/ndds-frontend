...
class AddPaymentPlanEndDateControllerSpec extends SpecBase with MockitoSugar {

  def onwardRoute = Call("GET", "/foo")

  val formProvider = new AddPaymentPlanEndDateFormProvider()
  ...
  "AddPaymentPlanEndDate Controller" - {
    ...
    "must redirect to System Error for a GET when DirectDebitSource is not SA" in {
    ...
    "must redirect to System Error for a POST when DirectDebitSource is not SA" in {
